/****************************************************************************
** Meta object code from reading C++ file 'imagedisplaycontroler.h'
**
...
#error "The header file 'imagedisplaycontroler.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 22, 9), // "sendImage"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 4) // "qImg"

    },
    "ImageDisplayControler\0sendImage\0\0qImg"
};
...
void ImageDisplayControler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageDisplayControler::sendImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageDisplayControler::sendImage(QImage _t1)
{
